...
const XDBPanel = (): React.ReactElement => {
  return (
    <>
      <div className="off-canvas-sidebar off-canvas-sidebar-right">
        <div className="btn-group-vertical hover" role="group">
          <button
            type="button"
            className="btn btn-info sidebar-closed"
            data-toggle="sidebar"
            title="Open visit details panel"
            data-side="right"
          >
          ...
          <button
            type="button"
            className="btn btn-info btn-lg sidebar-opened"
            style={{ display: 'none' }}
            data-toggle="sidebar"
            title="Close visit details panel"
            data-side="right"
          >
          ...
          <button
            style={{ display: 'none' }}
            className="btn btn-success refresh-sidebar sidebar-opened"
            title="Refresh visit details panel"
          >
            <span className="glyphicon glyphicon-refresh"></span>
            <span className="hover-only">Refresh</span>
          </button>
          <button
            className="btn btn-danger end-visit sidebar-opened"
            style={{ display: 'none' }}
            title="End the current visit and submit it to the Sitecore Experience Database"
          >
            ...
            <div className="panel panel-primary">
              <div className="panel-heading" role="tab">
                <h3 className="panel-title">
                  ...
                  >
                    ...
                    >
                      <span className="fa fa-heart"></span>0
                    </span>
                    <span
                      className="badge"
                      title="Pages Viewed"
                      ...
                      data-placement="bottom"
                    >
                      <span className="fa fa-eye"></span>0
                    </span>
                    <span
                      className="badge"
                      ...
                      data-placement="bottom"
                    >
                      <span className="fa fa-history"></span>1
                    </span>
              ...
              <div id="visitsPanel" className="panel-collapse collapse" role="tabpanel">
                <div className="panel-body">
                  ...
                  <table className="table table-condensed table-borderless"></table>
                  <div className="media">
                    <div className="media-left">
                      <span className="fa fa-history"></span>
                    </div>
                    <div className="media-body">
                      <h4 className="media-title">Visits to the site:</h4>
              ...
              <div id="personalInfoPanel" className="panel-collapse collapse" role="tabpanel">
                <div className="panel-body">
                  <div className="media">
                    ...
                    <div className="media-body ">
                      <h4 className="media-title">You are anonymous </h4>
                  ...
                  <div className="media">
                    ...
                    <div className="media-body ">
                      <h4 className="media-title">Device</h4>
              ...
              <div id="onsiteBehaviorPanel" className="panel-collapse collapse" role="tabpanel">
                <div className="panel-body">
                  <div className="media">
                    ...
                    <div className="media-body ">
                      <h4 className="media-title">Profiling</h4>
                      <div className="media-body">
                        <div className="alert alert-info small">You have not been profiled yet</div>
                      </div>
                    </div>
                  </div>
                  <div className="media">
                    ...
                    <div className="media-body ">
                      <h4 className="media-title">Triggered goals</h4>
                      <div className="media-body">
                        <ul className="nav nav-tabs nav-justified small">
                          <li className="active">
                            <a href="#onSiteBehaviorGoals" data-toggle="tab">
                              Goals
                            </a>
                          </li>
                          <li>
                            <a href="#onSiteBehaviorPageEvents" data-toggle="tab">
                              Page Events
                            </a>
                          </li>
                        </ul>
                  ...
                  <div className="media">
                    ...
                    <div className="media-body ">
                      <h4 className="media-title">Outcomes</h4>
                      <div className="alert alert-info small">You have reached no outcomes</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div id="referralPanel" className="panel-collapse collapse" role="tabpanel">
                <div className="panel-body">
                  <div className="media">
                    ...
                    <div className="media-body ">
                      <h4 className="media-title">Referrer</h4>
                  ...
                  <div className="media">
                    ...
                    <div className="media-body ">
                      <h4 className="media-title">Campaigns</h4>
                      <div className="alert alert-info small">
